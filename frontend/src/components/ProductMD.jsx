        ...
        <div className="flexCenter flex-col gap-[7px] flex-wrap">
          ...
          {product.images.map((image, index) => (
            <img
              ...
              className="max-h-[89px] rounded-lg bg-gray-10 cursor-pointer"
              onClick={() => setMainImage(image)} // Changer l'image principale
            />
          ))}
        </div>
          ...
          <div>
            ...
            <div className="flex gap-3 my-3">
              {["S", "M", "L", "XL"].map((size) => (
                <div
                  key={size}
                  onClick={() => setSelectedSize(size)} // Sélectionner la taille
