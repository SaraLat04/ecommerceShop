...
const List = ({ url }) => {
  ...
  const updateProduct = (productId) => {
    // Redirection vers la page de mise à jour avec l'ID du produit
          ...
          <tbody>
            {list.map((product) => (
              <tr key={product._id} className="border-b border-slate-900/20 text-gray-50 p-6 medium-14 text-left">
                ...
                <td className="p-1">
                  <div className="bold-22 flex gap-4">
                    <TbEdit onClick={() => updateProduct(product._id)} />
...
//               <tr key={product._id} className="border-b border-slate-900/20 text-gray-50 p-6 medium-14 text-left">
//                 <td className="p-1">
//                   <img src={`${url}/images/`+product.image} alt="" height={38} width={38} className="rounded-lg ring-1 
